...
//CONSTRUCTOR
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null)
        {
            String errorMessage = "", area ="",city,pinCode="";
...
//                            null, "",currentLocation,"",null,null,location_lat,location_lng);
            ...
            if (addressList == null || addressList.size() == 0) {
                ...
                deliverResultToReceiver(FetchAddressService.FAILURE_RESULT, errorMessage,
                        null,null,null,null,null,null,location_lat,location_lng);
            }
            else
            {
...
//              PIN_CODE
                ...
                deliverResultToReceiver(FetchAddressService.SUCCESS_RESULT, "Address Found.",
                        address, city,area,pinCode,addressArrList,addressArray,location_lat,location_lng);
