...
public class TakeImage extends Activity {
    ...
    private final String capture_dir = Environment.getExternalStorageDirectory() + "/Aqar55/Images/";
...
//				imageFileUri = FileProvider.getUriForFile(TakeImage.this,BuildConfig.APPLICATION_ID + ".provider",new File(path));
                imageFileUri = FileProvider.getUriForFile(TakeImage.this, "com.aqar55", new File(path));
