...
public class Add_Map_Location_Fragment extends Fragment implements View.OnClickListener,
    ...
    private Add_Map_Location_Fragment.AddressResultReceiver mResultReceiver;
...
//            });
    ...
    private void getAddress() {
        ...
        if (midLatLng != null) {
          ...
          if (addresses!=null) {
              ...
              Intent intent = new Intent("address-data");
            ...
            Toast.makeText(getContext(), "Please Select Valid Location", Toast.LENGTH_SHORT).show();
        }
    ...
    private void createLocationRequest() {
        ...
        mResultReceiver = new Add_Map_Location_Fragment.AddressResultReceiver(null);
    ...
    private void buildGoogleApiClient() {
        ...
        googleApiClient = new GoogleApiClient.Builder(getContext())
                ...
                .addConnectionCallbacks(Add_Map_Location_Fragment.this)
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        result.setResultCallback(Add_Map_Location_Fragment.this);
    }
                                ...
                                if (address != null) {
                                    ...
                                    Log.w("Results ARE: \n",
                                            ...
                                            "MESSAGE: \n" + msg
                                                    ...
                                                    + "\nLOC_LNG: \n" + lonng);
                                    LatLng latLng = new LatLng(lat, lonng);
                                    Add_Map_Location_Fragment.this.gm.animateCamera(CameraUpdateFactory.newLatLngZoom(latLng, 12));
                                    midLatLng = latLng;
