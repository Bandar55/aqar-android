...
public class PropertyListModel implements Serializable {
    @Expose
    @SerializedName("Data")
    private List<PropertyListModel.Data> data;
    @Expose
    ...
    public List<PropertyListModel.Data> getData() {
        return data;
    }
    ...
    public static class Data implements Serializable{
        ...
        private List<PropertyListModel.Videosfile> videosfile;
        @Expose
        @SerializedName("imagesFile")
        private List<PropertyListModel.Imagesfile> imagesfile;
        @Expose
        ...
        public List<PropertyListModel.Videosfile> getVideosfile() {
            return videosfile;
        }

        public List<PropertyListModel.Imagesfile> getImagesfile() {
            return imagesfile;
        }
        ...
        public void setVideosfile(List<PropertyListModel.Videosfile> videosfile) {
            this.videosfile = videosfile;
        }

        public void setImagesfile(List<PropertyListModel.Imagesfile> imagesfile) {
