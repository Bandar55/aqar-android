...
public class GetPropertyListing implements Serializable {
    @Expose
    @SerializedName("data")
    private List<Data> smalldata;
    @Expose
    @SerializedName("Data")
    ...
    public static class Data implements Serializable{
        ...
        public void setVideosfile(List<Videosfile> videosfile) {
            this.videosfile = videosfile;
        }

        public void setImagesfile(List<Imagesfile> imagesfile) {
