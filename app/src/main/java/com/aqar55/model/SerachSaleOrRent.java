...
public class SerachSaleOrRent {
    @Expose
    @SerializedName("data")
    private List<SerachSaleOrRent.Data> data;
    @Expose
    ...
    public List<SerachSaleOrRent.Data> getData() {
        return data;
    }
    ...
    public static class Data implements Serializable {
        ...
        private List<GetPropertyListing.Videosfile> videosfile;
        @Expose
        @SerializedName("imagesFile")
        private List<GetPropertyListing.Imagesfile> imagesfile;
        @Expose
        ...
        public List<GetPropertyListing.Videosfile> getVideosfile() {
            return videosfile;
        }

        public List<GetPropertyListing.Imagesfile> getImagesfile() {
            return imagesfile;
        }
