...
public class CountryCodePicker extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        view=(View)holderView.findViewById(R.id.view);
        codePicker = this;
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            view.setBackgroundColor(ccpViewColor);
            ImageViewCompat.setImageTintList(imageViewArrow, ColorStateList.valueOf(ccpArrowColor));
            ...
            textView_selectedCountry.setTextColor(contentColor);
