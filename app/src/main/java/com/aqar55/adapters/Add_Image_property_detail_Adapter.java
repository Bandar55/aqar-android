...
public class Add_Image_property_detail_Adapter extends RecyclerView.Adapter<Add_Image_property_detail_Adapter.ViewHolder> {
    private Context context;
    private int size = 4;

    public Add_Image_property_detail_Adapter(Context context) {
